...
class index(db.Model):
    ...
    def __init__(self, date=None, shift=None, target=None, opyhigh=None, opylow=None, lokasiprod=None, opyhighcrusher=None, opylowcrusher=None):
        self.date = date
        self.shift = shift
        self.target =  target
...
class tuban1(db.Model):
    ...
    def __init__(self, mining_date=None, shift=None, permpro_high_al=None, permpro_low_al=None, stok_storage_hal=None, stok_storage_lal=None, tambang_hal=None, 
